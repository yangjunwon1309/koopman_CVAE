...
class Trainer:
    LOG_KEYS = [
        ...
        'loss_skill_arg_smooth', 'loss_skill_arg_var',
        'loss_skill_arg_cov',
        # v5 diagnostics
        'rho', 'q_scale',
    ]
    ...
    def _run_loop(self, train_loader, val_loader,
        ...
        for local_ep in range(1, n_epochs + 1):
            ...
            if stage_tag == 'skilldec':
                ...
                if metrics.get('loss_skill_arg_smooth', 0.0) != 0.0:
                    line += f"  sm={metrics['loss_skill_arg_smooth']:.4f}"
                if metrics.get('loss_skill_arg_var', 0.0) != 0.0:
                    line += f"  var={metrics['loss_skill_arg_var']:.4f}"
                if metrics.get('loss_skill_arg_cov', 0.0) != 0.0:
                    line += f"  cov={metrics['loss_skill_arg_cov']:.4f}"
            else:
    ...
    def _train_skill_arg_decoder(self, train_loader, val_loader, t0: float):
        ...
        print(
            ...
            f"branch={int(getattr(self.model.cfg, 'skill_arg_branch_decoder', False))} "
            f"softmix={int(getattr(self.model.cfg, 'skill_arg_branch_soft_mix', False))} "
            f"prior_nll={int(getattr(self.model.cfg, 'skill_arg_policy_nll', False))}",
            flush=True,
        )
        print(
            f"  arg regularizers: smooth={getattr(self.model.cfg, 'lambda_skill_arg_smooth', 0.0)} "
            f"var={getattr(self.model.cfg, 'lambda_skill_arg_var', 0.0)} "
            f"cov={getattr(self.model.cfg, 'lambda_skill_arg_cov', 0.0)} "
            f"var_floor={getattr(self.model.cfg, 'skill_arg_var_floor', 0.05)}",
            flush=True,
        )
        print(f"{'='*60}", flush=True)
        ...
        self.model.cfg.lambda_skill_arg_progress = (
            self.args.lambda_skill_arg_progress)
        self.model.cfg.lambda_skill_arg_smooth = (
            self.args.lambda_skill_arg_smooth)
        self.model.cfg.lambda_skill_arg_var = self.args.lambda_skill_arg_var
        self.model.cfg.lambda_skill_arg_cov = self.args.lambda_skill_arg_cov
        self.model.cfg.skill_arg_var_floor = self.args.skill_arg_var_floor
        self.model.cfg.phase = 3
        self.phase2_epoch = 0
        self.phase3_epoch = 0
...
def parse_args():
    p = argparse.ArgumentParser(
        description='Train KODAQ skill-argument prior with branched skill decoders')
    ...
    p.add_argument('--no_skill_arg_branch_decoder', action='store_true',
                   help='Disable one-decoder-per-skill branching.')
    p.add_argument('--skill_arg_branch_soft_mix', action='store_true',
                   help='Blend skill branches by soft skill weights instead of hard argmax routing.')
    p.add_argument('--skill_arg_policy_mse', action='store_true',
                   help='Use old tanh-argument MSE prior loss instead of Gaussian NLL.')
    ...
    p.add_argument('--lambda_skill_arg_smooth', type=float, default=0.1)
    p.add_argument('--lambda_skill_arg_var', type=float, default=0.01)
    p.add_argument('--lambda_skill_arg_cov', type=float, default=0.001)
    p.add_argument('--skill_arg_var_floor', type=float, default=0.05)
...
if __name__ == '__main__':
    ...
    cfg.skill_arg_branch_decoder = not args.no_skill_arg_branch_decoder
    cfg.skill_arg_branch_soft_mix = args.skill_arg_branch_soft_mix
    cfg.skill_arg_policy_nll = not args.skill_arg_policy_mse
    ...
    cfg.lambda_skill_arg_smooth = args.lambda_skill_arg_smooth
    cfg.lambda_skill_arg_var = args.lambda_skill_arg_var
    cfg.lambda_skill_arg_cov = args.lambda_skill_arg_cov
    cfg.skill_arg_var_floor = args.skill_arg_var_floor
    ...
    if is_resume:
        ...
        resume_cfg.skill_arg_branch_decoder = not args.no_skill_arg_branch_decoder
        resume_cfg.skill_arg_branch_soft_mix = args.skill_arg_branch_soft_mix
        resume_cfg.skill_arg_policy_nll = not args.skill_arg_policy_mse
        ...
        resume_cfg.lambda_skill_arg_smooth = args.lambda_skill_arg_smooth
        resume_cfg.lambda_skill_arg_var = args.lambda_skill_arg_var
        resume_cfg.lambda_skill_arg_cov = args.lambda_skill_arg_cov
        resume_cfg.skill_arg_var_floor = args.skill_arg_var_floor
        resume_cfg.phase               = 3
        cfg = resume_cfg
        ...
        if args.train_skill_decoder:
            ...
            print(f"    epochs={args.skill_arg_epochs} lr={args.skill_arg_lr} "
                  ...
                  f"branch={int(not args.no_skill_arg_branch_decoder)} "
                  f"prior_nll={int(not args.skill_arg_policy_mse)}",
                  flush=True)
        else:
